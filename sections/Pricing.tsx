          ...
          ({
            ...
            features,
              ...
              <div className='flex justify-between'>
               ...
               className='bg-[linear-gradient(to_right,#DD7DDF,#E1CD86,#BBCB92,#3BFFFF,#DD7DDF)] [background-size:200%] text-transparent bg-clip-text font-medium'> 
                Popular
                </motion.span>
                 </div>
                  )
                ...
                <div className='flex items-baseline gap-1 mt-[30px]'>
                  ...
                  <span className='tracting-tight font-bold text-black/50'>/month</span>
                </div>
